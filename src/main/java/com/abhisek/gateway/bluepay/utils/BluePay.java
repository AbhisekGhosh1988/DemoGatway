...
public String getBP_MERCHANT() {
	return BP_MERCHANT;
}
public void setBP_MERCHANT(String bP_MERCHANT) {
	BP_MERCHANT = bP_MERCHANT;
}
public String getBP_SECRET_KEY() {
	return BP_SECRET_KEY;
}
public void setBP_SECRET_KEY(String bP_SECRET_KEY) {
